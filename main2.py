...
aa=0.2 #控制参数，取到0-1之间，数字越大越遵循MM马尔科夫链
#找音符ID 的函数
def FindID(MM,num):
    for id in range(len(MM)):
        if MM[id][0]==num:
            return id  
    return random.randint(0,len(MM)-1)

def MyList(MM,IdList,PitchList):
    newList=[]
    for id in IdList:
        for q in PitchList:
            if MM[id][0]==q:
                newList.append(id)
    if(len(newList)==0):
        newList.append(FindID(MM,random.choice(PitchList)))
    return newList
...
c=[]
m=[]
c.append(ms21.converter.parse('master\璃月-璃月的晴空_chord.mid'))
ky=c[0].analyze('key')
print(ky)
if ky.mode == 'minor':
...
c[0]=c[0].transpose(i)
#整合所有样本
c.append(ms21.converter.parse('master\璃月-不再年轻的村庄_chord.mid'))
ky=c[1].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
c.append(ms21.converter.parse('master\璃月-虹霞垂天_chord.mid'))
ky=c[2].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
c.append(ms21.converter.parse('master\璃月-晚安璃月_chord.mid'))
ky=c[3].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
c.append(ms21.converter.parse('master\璃月-希望的明日_chord.mid'))
ky=c[4].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
c.append(ms21.converter.parse('master\璃月-源流汇响_chord.mid'))
ky=c[5].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
'''
c.append(ms21.converter.parse('master\璃月-岩壑之崩_chord.mid'))
ky=c[5].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
'''
#旋律部分
m.append(ms21.converter.parse('master\璃月-璃月的晴空_melody.mid'))
ky=m[0].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-不再年轻的村庄_melody.mid'))
ky=m[1].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-虹霞垂天_melody.mid'))
ky=m[2].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-晚安璃月_melody.mid'))
ky=m[3].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-希望的明日_melody.mid'))
ky=m[4].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-源流汇响_melody.mid'))
ky=m[5].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
m.append(ms21.converter.parse('master\璃月-品茗尝清心_melody.mid'))
ky=m[6].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
'''
m.append(ms21.converter.parse('master\璃月-岩壑之崩_melody.mid'))
ky=m[5].analyze('key')
print(ky)
if ky.mode == 'minor':
    i = ms21.interval.Interval(ky.parallel.tonic, ms21.pitch.Pitch('C'))
...
for iii in range(200):
    ...
    for i in range(len(R[rid][1][j][0])):
        ...
        if (len(MM[mid][1])!=0 and len(C[cid][1])!=0):
            rr=random.random()
            if rr*(1+m_newnote.duration.quarterLength)<aa:
                mid=random.choice(MM[mid][1])
            else:
                newList=MyList(MM,MM[mid][1],C[cid][1])
                mid=random.choice(newList)
        elif len(C[cid][1])!=0:
            mid=FindID(MM,random.choice(C[cid][1]))
        else:
